...
public class ChatbotLocator : MonoBehaviour
{
    public TMPro.TextMeshProUGUI distanceText;

    private Vector2 targetCoordinates = new Vector2(33.6559f, 73.0169f);
    ...
    private void Update()
    {
        if (Input.location.isEnabledByUser && Input.location.status == LocationServiceStatus.Running)
        {
            ...
            distanceText.text = "Chatbot: " + distance.ToString("F2") + " meters away";
        }
    }
